...
} from './angular-test-environment.spec';
...
describe('SxDirective', () => {
  ...
  it('unsubscribes a replaced source and ignores stale pending emissions', () => {
    ...
    // Replacement is synchronous: Angular must already show the new source
    // and the old subscription must be gone before the queued renderer frame.
