...
function routeWithComponent(path: string, text: string): Route {
  return {
    path,
    loadComponent: () => Promise.resolve(createComponent(text))
  };
}
    ...
    it('should match parameterized routes', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'users/:id',
            loadComponent: () => Promise.resolve(createComponent('User'))
          },
        ],
        outlet,
      };
    ...
    it('should match wildcard routes', async () => {
      const config: RouterConfig = {
        routes: [
          ...
          {
            path: '**',
            loadComponent: () => Promise.resolve(createComponent('404'))
          },
        ],
        outlet,
      };
            ...
            children: [
              {
                path: 'users',
                data: { section: 'users' },
                loadComponent: () => Promise.resolve(createComponent('Admin Users')),
              },
            ],
          },
        ],
    ...
    it('should redirect when guard returns a redirect string', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'old',
            loadComponent: () => Promise.resolve(createComponent('Old')),
            canActivate: [() => '/new'],
          },
    ...
    it('should support async guards', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'async',
            loadComponent: () => Promise.resolve(createComponent('Async')),
            canActivate: [
              async () => {
                await delay(10);
                return true;
    ...
    it('should execute multiple guards in order', async () => {
      ...
      const config: RouterConfig = {
        routes: [
          {
            path: 'guarded',
            loadComponent: () => Promise.resolve(createComponent('Guarded')),
            canActivate: [
    ...
    it('should support async resolvers', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'async-data',
            loadComponent: () => Promise.resolve(createComponent('Async Data')),
            resolve: {
              data: async () => {
                await delay(10);
    ...
    it('should merge static data and resolved data', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'merged',
            loadComponent: () => Promise.resolve(createComponent('Merged')),
    ...
    it('should handle parameterized redirects', async () => {
      const config: RouterConfig = {
        routes: [
          ...
          {
            path: 'profiles/:id',
            loadComponent: () => Promise.resolve(createComponent('Profile')),
          },
        ],
        outlet,
      };
    ...
    it('should lazy load components', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'lazy',
            loadComponent: () => Promise.resolve(createComponent('Lazy Loaded')),
          },
        ],
        outlet,
      };
    ...
    it('should expose error state on navigation failure', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'error',
            loadComponent: () => Promise.reject(new Error('Component failed')),
          },
        ],
        outlet,
      };
    ...
    it('should handle guard errors', async () => {
      const config: RouterConfig = {
        routes: [
          {
            path: 'error',
            loadComponent: () => Promise.resolve(createComponent('Error')),
            canActivate: [
              () => {
